...
# Data
The data collected from the Udacity car was images (mostly .jpg) from 3 cameras (left, center, right spaced 20 inches apart) and steering angles. There are several different data sets, but in the end I only ended up using the final two as some of the camera issues had been worked out by that point. The first one (I will refer to as Dataset 1) is approximately 3 hours of driving from El Camino Real and the second (Dataset 2) is a combination of highway driving and curvy driving over Highway 92 from San Mateo to Half Moon Bay. The links to the torrents for the datasets are here: 
